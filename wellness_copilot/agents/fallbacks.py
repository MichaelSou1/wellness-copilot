...
_EXPERT_FALLBACKS = {
    ...
    "Psychologist": (
        "抱歉，心理疗愈建议节点暂时不可用。我先给你一个保守原则：先降低刺激和压力负荷，"
        "用 5-10 分钟呼吸放松、担忧清单或短暂离开触发场景来缓冲；"
        "若出现自伤/轻生念头、持续恐慌、严重抑郁或失眠超过两周，请尽快联系心理/睡眠门诊或当地危机支持。"
    ),
    "Doctor": (
        "抱歉，医学建议节点暂时不可用。我先给你一个保守原则：如果问题涉及明显身体不适、急性症状、"
        "持续疼痛、用药或处方，请优先联系医生、药师或当地急救服务。仅供参考，如有不适请就医。"
    ),
}
